My code is available on github at:
...
My repository contains 9 files:
	...
	- 6 files that are the implementations for each algorithm on both problem, for example QBAgent contains the Q-learning algorithm for blackjack whereas QAgent is for tic-tac-toe ; launching these files generate the metrics used for the report
